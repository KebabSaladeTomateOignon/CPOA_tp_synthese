...
public class ControlWindow extends JInternalFrame {
	...
	private AgentControlGUI 	agentControlGUI;
	private SimulatorControlGUI simulatorControlGUI;
	...
	public ControlWindow(World world,  Simulator simulator){
    	...
    	private void createGui(World world,Simulator simulator){
    	    ...
    	    this.agentControlGUI = new AgentControlGUI(world,simulator);
    	    this.simulatorControlGUI = new SimulatorControlGUI((JFrame)getParent(),simulator);
    	    panel.add(this.agentControlGUI);
    	    panel.add( this.simulatorControlGUI);
    	    pack();
    	}
    ...
    {
    	return this.simulatorControlGUI.hasStarted();
    }
}
