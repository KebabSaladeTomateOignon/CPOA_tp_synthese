...
public class Simbad extends JFrame implements ActionListener {
     ...
     */
    private void createInternalFrames(EnvironmentDescription ed) {
        ...
        timerWindow = new TimerWindow( ((tpsynthese.MyEnv) ed).getSecondes() );
        desktop.add(timerWindow);
        timerWindow.show();
        timerWindow.setLocation(350, 570);
    ...
    {
    	return this.simulator.getStarted();
    }

    /**
     * 
     * @return Retourne la frame Timer.
     */
    ...
    /*
     * Réinitialise le nombre de secondes.
     */
    public void resetTimer()
    {
    	this.timerWindow.resetSecondes();
    }
    
    /**
     * Ferme la window Timer.
     */
    ...
    /**
     * 
     * @return Retourne true si le temps est écoulé.
     */
    public boolean isFinished()
    {
    	return this.timerWindow.isFinished();
    }
    
    /**
     *
     * @return Retourne true si le joueur veut rejouer.
     */
    public boolean retryGame()
    {
    	int val = JOptionPane.showConfirmDialog(this, "Voulez-vous rejouer ?", "Temps terminé", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE);
    ...
    {
    	JOptionPane.showMessageDialog(this, "Merci d'avoir joué au jeu Portal, à bientôt !" + "\n" + "Fermeture automatique du jeu...", "Fin du jeu", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void winGame()
    {
    	JOptionPane.showMessageDialog(this, "Félicitations vous avez gagné, à bientôt !" + "\n" + "Fermeture automatique du jeu...", "Fin du jeu", JOptionPane.INFORMATION_MESSAGE);
